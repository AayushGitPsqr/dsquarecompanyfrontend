...
export function CameraCapture({ onCapture, onCancel, busy = false }) {
    ...
    return (_jsxs("section", { className: "premium-shell rounded-[28px] p-3 sm:p-4", children: [_jsx("div", { className: "scanner-orb scanner-orb--a" }), _jsx("div", { className: "scanner-orb scanner-orb--b" }), _jsx("div", { className: "relative rounded-[24px] border border-black/5 bg-white/65 p-4 shadow-glass backdrop-blur-xl sm:p-5", children: _jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between", children: [_jsx("div", { className: "space-y-3", children: _jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.18em] text-aqua-deep", children: "Smart camera" }), _jsx("h3", { className: "mt-1 text-3xl font-semibold tracking-tight text-ink sm:text-[2.15rem]", children: "Capture the card in one tap" }), _jsx("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-slate sm:text-[0.95rem]", children: "Point the camera at the business card. OpenAI reads it, then you verify the extracted details before saving to MongoDB." })] }) }), _jsx("div", { className: "flex flex-wrap items-center gap-2", children: _jsxs("button", { type: "button", onClick: () => {
                                    stopCamera();
                                    onCancel();
