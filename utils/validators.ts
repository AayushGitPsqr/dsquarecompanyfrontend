import type { BusinessCardDraft, BusinessCardScanData } from "../types";
...
export function validateBusinessCard(card: Partial<BusinessCardDraft>) {
  const errors: Partial<Record<keyof BusinessCardDraft, string>> = {};
...
export function businessCardFromPartial(
  card: Partial<BusinessCardDraft> | Partial<BusinessCardScanData>
): BusinessCardDraft {
  return {
